...
#define STRING_CONFIG_H_AUTHOR "(Sam@TechnologyOutlet)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CopyMaster 300"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION 287
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75   // (mm) Diameter of the filament generally used (3.0 or 1.75mm), also used in the slicer. Used to validate sensor reading.
  ...
  #define MAX_MEASUREMENT_DELAY       
    ...
    // (bytes) Buffer size for stored measurements (1 byte per cm). Must be larger than MEASUREMENT_DELAY_CM.
